...
function checkAns1(){
    ...
    if(try1 == 1){
        ...
        const node1 = document.createTextNode("That's correct! The most important principle is to tailr your application to the hob description.");
...
function checkAns2(){
    ...
    if(try2 == 3){
        console.log('correct ans');    
        const node2 = document.createTextNode("Well done! Listing a skill without evidencing it is not a good idea.");
        para2.appendChild(node2);
        feedback2.appendChild(para2);
        feedback2.style["background-color"] = "#CAEEC2";
    }else{
        console.log('incorrect');
        const node2 = document.createTextNode("That's not quite right. Whilst the other other ideas may well be suitable to include, listing a skill without evidencing it is not a good idea.");
        para2.appendChild(node2);
        feedback2.appendChild(para2);
...
function checkAns3(){
    ...
    if(try3 == 4){
        console.log('correct ans');    
        const node3 = document.createTextNode("That's correct! Each item above is important to consider when compiling your application.");
        para3.appendChild(node3);
        feedback3.appendChild(para3);
        feedback3.style["background-color"] = "#CAEEC2";
    }else{
        console.log('incorrect');
        const node3 = document.createTextNode("That's not quite right. Each item above is important to consider when compiling your application.");
        para3.appendChild(node3);
        feedback3.appendChild(para3);
